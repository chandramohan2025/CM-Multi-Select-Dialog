...
public class MultiSelectDialog extends AppCompatDialogFragment implements SearchView.OnQueryTextListener, View.OnClickListener {
    ...
    private ViewRenderedListener viewRenderedListener;
    ...
    public MultiSelectDialog showAddNewButton(boolean addNewButton){
    ...
    public MultiSelectDialog onAdd(@NonNull ViewRenderedListener callback) {
   ...
   /* public void setCallbackListener(SubmitCallbackListener submitCallbackListener) {
    ...
    public interface ViewRenderedListener{
        void onAdded(RelativeLayout addRl, EditText addName,TextView addButton,TextView addLabel,TextView addError,ProgressBar progress,MultiSelectDialog multiSelectDialog);
    }
